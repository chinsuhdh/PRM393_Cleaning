...
public static class BookingOptionValidator
{
        ...
        ILogger? logger = null)
    {
        ...
        var questions = ParseQuestions(schemaJson, logger);
    ...
    private static List<SchemaQuestion> ParseQuestions(string? schemaJson, ILogger? logger = null)
    {
        ...
        {
            logger?.LogWarning(ex, "Không thể phân tích BookingFormSchema, bỏ qua các câu hỏi tùy chọn.");
            return result;
        }
