...
namespace Cleaning.BLL.Features.Profiles
{
    ...
    public class ProfileService : IProfileService
    {
        ...
        public async Task<bool> DeleteAccountAsync(Guid userId)
        {
            ...
            catch (DbUpdateException ex) when (PostgresExceptionHelpers.IsSqlState(ex, PostgresErrorCodes.ForeignKeyViolation))
            {
                throw new AppException(AppErrors.CannotDeleteAccountWithBookingHistory);
            }
        }
    }
}