...
namespace CleaningService.API.Features.Admin
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        {
            await _adminService.ApproveWorkerApplicationAsync(id, dto);
            return NoContent();
        }
        ...
        {
            await _adminService.RejectWorkerApplicationAsync(id, dto);
            return NoContent();
        }
        ...
        {
            await _adminService.ChangeAccountStatusAsync(id, dto);
            return NoContent();
        }
